        ...
        <div class="login-block">
            <div class="row">
                <div class="col-lg-6 col-md-7">
                    ...
                    <div class="sign-up"><?php echo e(__('Do not have an account')); ?>?  <a href="<?php echo e(route('register')); ?>" title="" target="_blank"><?php echo e(__('Sign up')); ?></a></div>
                </div>
...
<?php echo $__env->make('theme2.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eclass\resources\views/quedecato/front/auth/login.blade.php ENDPATH**/ ?>