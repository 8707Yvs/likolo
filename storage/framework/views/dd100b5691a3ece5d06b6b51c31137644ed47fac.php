        ...
        <div class="login-block">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-7">
                    ...
                    <h4 class="container-heading"><?php echo e(__('Create an account')); ?></h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="sign-up already-account"><?php echo e(__('Already have an account ')); ?>? <a href="<?php echo e(route('login')); ?>" title="" target="_blank"><?php echo e(__('Login')); ?></a>
                            </div>
                        </div>
                    </div>
                </div> 
...
<?php echo $__env->make('theme2.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eclass\resources\views/quedecato/front/auth/register.blade.php ENDPATH**/ ?>