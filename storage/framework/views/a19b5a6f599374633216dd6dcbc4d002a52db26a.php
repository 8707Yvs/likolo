        ...
        <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(url('page/create')); ?>" class="float-right btn btn-primary-rgba mr-2" title="<?php echo e(__('Add Page')); ?>"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add Page')); ?></a>
                        <?php endif; ?>
                        </div>
                      </div>
                </div> 
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            ...
                                            <a class="dropdown-item" href="<?php echo e(url('page/'.$p->id.'/edit')); ?>" title="<?php echo e(__('Edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pages.delete')): ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eclass\resources\views/admin/pages/index.blade.php ENDPATH**/ ?>