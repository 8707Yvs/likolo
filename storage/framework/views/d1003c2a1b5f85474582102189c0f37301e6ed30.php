            ...
            <div class="col-lg-4 col-md-6 ">
                <div class="courses-item mb-30 hover-zoomin">
                    <div class="thumb fix">
                        ...
                        <a href="single-courses.html"><img src="<?php echo e(asset('images/course/'.$enrol->courses->preview_image)); ?>" alt="contact-bg-an-01"></a>
                        <?php else: ?>
                        <a href="single-courses.html"><img src="<?php echo e(asset('images/course/'.$enrol->courses->preview_image)); ?>" alt="contact-bg-an-01"></a>
                        <?php endif; ?>
                    </div>
                    <div class="courses-content">                                    
                        ...
                        <h3><a href="single-courses.html"> <?php echo e(optional($enrol->courses->user)['fname']); ?></a></h3>
                    ...
                    <div class="icon">
                        <?php if($enrol->user['user_img'] !== NULL && $enrol->user['user_img'] !== ''): ?>
                        <img src="<?php echo e(asset('images/user_img/'.$enrol->user['user_img'])); ?>" alt="img">
                        <?php else: ?>
...
<?php echo $__env->make('theme2.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eclass\resources\views/quedecato/front/my_course.blade.php ENDPATH**/ ?>