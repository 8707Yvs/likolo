...
<!-- JS here -->
<script src="<?php echo e(url('frontcss/js/vendor/modernizr-3.5.0.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/vendor/jquery-3.6.0.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/popper.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/bootstrap.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/slick.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/ajax-form.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/paroller.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/wow.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/js_isotope.pkgd.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/imagesloaded.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/parallax.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/jquery.waypoints.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/jquery.counterup.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/jquery.scrollUp.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/jquery.meanmenu.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/parallax-scroll.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/jquery.magnific-popup.min.js')); ?>"></script>
<script src="<?php echo e(url('frontcss/js/element-in-view.js')); ?>"></script>
<?php if(in_array($language,$rtl)): ?>
<script src="<?php echo e(url('frontcss/js/main_rtl.js')); ?>"></script>
<?php else: ?>
<script src="<?php echo e(url('frontcss/js/main.js')); ?>"></script>
<?php endif; ?>
...
<?php endif; ?>
<?php echo $__env->yieldContent('custom-script'); ?><?php /**PATH C:\laragon\www\eclass\resources\views/theme2/scripts.blade.php ENDPATH**/ ?>